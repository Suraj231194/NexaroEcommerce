    ...
    <div className="pb-12 pt-8">
      <div className="container-shell">
        <div className="mb-6 rounded-2xl border border-border/70 bg-gradient-to-r from-card to-secondary/35 p-5">
          ...
          <p className="mt-2 text-sm text-muted-foreground">Guidelines and rules for using the platform.</p>
        </div>

        <section className="surface-card p-6 md:p-8">
          <p className="text-sm text-muted-foreground md:text-base">
            Placeholder terms page. Replace this with your real terms of service.
          </p>
          <div className="mt-6">
